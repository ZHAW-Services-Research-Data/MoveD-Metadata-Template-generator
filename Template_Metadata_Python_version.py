...
software_collection = ["Name", "Manufacturer", "Version", "Type of data which were collected", "Data format of the raw data (xcp, etc.)"]
hardware_collection = ["Name", "Manufacturer", "Type of data which were collected", "Electrode material, shape, size (if applicable, otherwise enter na)", "Measurement frequency [Hz]"]
...
tasks = ["Naming convention (abbreviation) of task", "Description of task (If walking or running was performed: indicate gait speed)"]
sensors = ["Abbreviation", "Segment name", "Explanation marker/sensor placement"]
